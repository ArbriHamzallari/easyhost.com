    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--surface)] p-6">
      <div className="max-w-lg rounded-[20px] border border-[var(--border)] bg-white p-8 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
        ...
        <p className="mt-3 text-[14px] text-[var(--muted)]">
          The most common cause is the database schema not being up to date. Try running:
        </p>
        <pre className="mt-3 overflow-x-auto rounded-[8px] bg-[var(--surface)] p-3 text-[12px] font-mono text-[var(--foreground)]">
          npx prisma db push
        </pre>
